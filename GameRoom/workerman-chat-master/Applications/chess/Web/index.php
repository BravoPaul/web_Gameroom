<html><head>
  ...
  <script type="text/javascript">
    ...
    var ws, name, client_id,adverse_id,ready = 0,wait = 0;
    ...
    <div class="chess_left">
        ...
        <div>
			...
			-->
                ...
                <input type="button" name="stypeBn" id="stypeBn" value="skin"   /><input type="button" name="download" id="download" value="源码下载"  hidden onClick="window.open('https://github.com/itlwei/ChinaChess-html5')" />
            </div>
        </div>
