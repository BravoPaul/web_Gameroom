...
<head>
    ...
    <script type="text/javascript">
        ...
        var ws, name,client_list={},wait= 0,room_id = 0;
            ...
            switch(data['type']){
                ...
                case 'gameStart':
                    if (confirm("You will have game with "+data['from_client_name'])){
                        if(room_id==1){
                            window.open ("http://192.168.0.13:55154",""+name+"");
                        }
                        else if(room_id==2){
                            window.open ("http://192.168.0.13:55152",""+name+"");
                        }
                        else if(room_id==3){
                            window.open ("http://192.168.0.13:55153",""+name+"");
                        }
                    }
                    break;
                case 'refuse':
